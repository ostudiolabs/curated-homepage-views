  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-20 px-4 bg-gradient-hero border-b border-border">
        <div className="max-w-4xl mx-auto text-center">
          <div className="animate-fade-in">
            <h1 className="text-5xl md:text-7xl font-bold text-foreground mb-6">
              Creative
              <span className="bg-gradient-creative bg-clip-text text-transparent"> Portfolio</span>
            </h1>
        ...
        <div className="absolute bottom-20 right-10 w-16 h-16 bg-gradient-creative rounded-full opacity-30 animate-float" style={{ animationDelay: '1s' }} />
      </section>
